        ...
        <section className="hero-grid">
          <div className="hero-copy brutal-card brutal-yellow">
            ...
            {/* <div className="hero-stats">
              <div className="stat-box brutal-card brutal-white rotate-left">
                <strong>2+ Years</strong>
                <span>Design + frontend work</span>
              </div>
              <div className="stat-box brutal-card brutal-pink rotate-right">
                <strong>20+</strong>
                <span>Prototypes created</span>
              </div>
              <div className="stat-box brutal-card brutal-blue rotate-left-soft">
                <strong>40%</strong>
        ...
        <section id="contact" className="stack-section">
          <article className="brutal-card brutal-black section-card contact-panel">
            ...
            <div className="contact-grid">
              ...
              <div className="brutal-card brutal-yellow contact-box">
                <span className="contact-icon">⌂</span>
                <p>Location</p>
